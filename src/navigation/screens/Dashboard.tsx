...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#f0f4f7", paddingVertical: 15 },
  header: { fontSize: 24, fontWeight: "bold", marginBottom: 20, textAlign: "center" },
  sectionTitle: { fontSize: 18, fontWeight: "600", marginTop: 15, marginBottom: 10 },
  row: { flexDirection: "row", justifyContent: "space-between", flexWrap: "wrap", marginBottom: 10, gap: 10 },
  card: { backgroundColor: "#ffffff", marginVertical: 5, padding: 15, borderRadius: 10, elevation: 3, shadowColor: "#000", shadowOpacity: 0.1, shadowOffset: { width: 0, height: 2 }, shadowRadius: 3, alignItems: "center", minWidth: "48%" },
  cardTitle: { fontSize: 14, color: "#666", marginBottom: 5 },
  cardValue: { fontSize: 20, fontWeight: "bold" },
  taskCard: { backgroundColor: "#ffffff", padding: 15, borderRadius: 10, marginBottom: 10, elevation: 2 },
  taskTitle: { fontSize: 16, fontWeight: "bold" },
  taskDue: { fontSize: 14, color: "#666", marginTop: 5 },
  notificationCard: { flexDirection: "row", alignItems: "center", backgroundColor: "#e1f5fe", padding: 12, borderRadius: 10, marginBottom: 8 },
  notificationText: { fontSize: 14 },
  actionButton: { flex: 1, flexDirection: "row", justifyContent: "center", backgroundColor: "#0277bd", margin: 5, padding: 12, borderRadius: 8, alignItems: "center", minWidth: "48%" },
